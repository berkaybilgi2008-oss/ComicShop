...
///
/// Iki isi var:
///   1) Kisa cikis hareketinden sonra ince kenariyla bicak gibi ucar.
...
public class ThrownBook : MonoBehaviour
{
    ...
    [Tooltip("Kisa cikistan sonra kitabin uzun eksenini ucusa hizalar ve taklayi durdurur. " +
    ...
    void FixedUpdate()
    {
        ...
        Vector3 normal = Vector3.ProjectOnPlane(spinAxis, direction);
        ...
        body.MoveRotation(Quaternion.Slerp(launchRotation, aligned, blend));
    }
